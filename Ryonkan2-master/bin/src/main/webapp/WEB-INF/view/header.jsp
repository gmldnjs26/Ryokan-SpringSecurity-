...
<link rel="stylesheet" media="all" href="../fcommon/css/join.css?ver=2">
		...
		<div id="header">
			...
			<div class="header_bottom">
				<div class="gnb_box">
					<div class="contains">
						<h1 class="logo">
							<a href="/"> <img src="file/profile/sinfo/8bc4a711e24c688437b4163177a60cd8_IMG181120094759.png" alt="제일펫푸드" class="hide_mobile"> <img src="../common/img/common/p.png" alt="제일펫푸드" class="show_mobile">
							</a>
						</h1>
						...
						<div class="gnb_area">
							...
							<div class="gnb_wrap gnb_right">
								...
								<div class="gnb_scroll">
									<!-- 모바일 메뉴 -->
									<ul id="gnb">
										<li class="menu "><a href="/" class="btn_menu">三木屋について</a> <span class="icon"></span>
