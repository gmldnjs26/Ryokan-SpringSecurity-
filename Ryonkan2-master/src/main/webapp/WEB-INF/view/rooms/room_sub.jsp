			...
			<div class="contains">
				...
				<div class="notice_wrap">
					...
					<div id="schRoom" class="search schBox room schForm active" style="display: block;">
						<form name="srchRoomFrm" id="srchRoomFrm" method="post" action="/reserve/insert1">
							<div class="schFm">
								...
								<input type="hidden" value="${loginMember.mber_id }" name="mber_id">
								<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
								<!-- check in // -->
								<div class="schPeriod checkin_icon i-schperiod">
									<input type="text" class="ipt-2 dropup" title="Check In" name="check_in" id="depart" placeholder="Check In" readonly="readonly" value="${checkIn }">
								</div>
								<!-- // check in -->

								<!-- check out // -->
								<div class="schOption ico i-schOpt">
									<input type="text" id="return" name="check_out" class="ipt-2" title="Check Out" placeholder="Check Out" readonly="readonly" value="${checkOut }">
								</div>
								<!-- // check out -->
							</div>
