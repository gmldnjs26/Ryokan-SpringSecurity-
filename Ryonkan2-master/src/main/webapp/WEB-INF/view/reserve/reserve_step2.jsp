...
<div id="content" class="sub company_panel company">
	<div class="wrapping">
		...
		<div class="partner_top">
			...
			<!-- //상단 서브 배너 영역 ---------------------->
			<form action="/reserve/insert2" name="frm" method="post">
				...
				<div class="contains">
					...
					<c:forEach var="mealVO" items="${mealList}" varStatus="status">
						...
						<div class="info_box_wrap meal_box_wrap">
							<p class="title">${mealVO.m_title }<button type="button"
									onclick="view(${status.count})" class="btn_vh active">
									<img src="">
								</button>
							</p>
							<div class="table_box">
								<div class="table_td img_box">
									<input type="radio"
										...
										name="m_code" value="${mealVO.m_code }"> <img
										src="../upload/dish/${mealVO.m_code}/${mealVO.m_photo1}"
										class="dish_img" alt="${mealVO.m_title}" />
								</div>
