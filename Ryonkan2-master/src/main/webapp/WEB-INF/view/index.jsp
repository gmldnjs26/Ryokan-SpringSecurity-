...
.search .btnRefresh:before {
	...
	<div class="schFormWrap">
		...
		<div id="schRoom" class="search schBox room schForm active" style="display: block;">
			<form name="srchRoomFrm" id="srchRoomFrm" method="post" action="/reserve/search">
				<div class="schFm">
					<!-- check in // -->
					<div class="schPeriod checkin_icon i-schperiod">
						<input type="text" class="ipt-2 dropup" title="Check In" name="checkIn" id="depart" placeholder="Check In" readonly="readonly">
					</div>
					<!-- // check in -->
					
					<!-- check out // -->
					<div class="schOption ico i-schOpt">
						<input type="text" id="return" name="checkOut" class="ipt-2" title="Check Out" placeholder="Check Out" readonly="readonly">
					</div>
					<!-- // check out -->
				</div>
				<div class="schCheck">
